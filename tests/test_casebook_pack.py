"""Regression checks for the hexpane casebook."""
...
from casebook.harness import assert_expected, hexpane_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(hexpane_summary(), assert_expected())
